...
namespace Dissonance.Demo
{
        ...
        : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            {
                _canvas.alpha = 1;
                _fadeOutStartTime = DateTime.Now + TimeSpan.FromSeconds(4);
            }
            else if (_fadeOutStartTime < DateTime.Now)
            {
                var time = (float)(DateTime.Now - _fadeOutStartTime).TotalSeconds / 2;
                if (time > 0)
                {
        ...
        {
            _fadeOutStartTime = DateTime.Now + time;
        }
