    ...
    internal class OpusNative
    {
        ...
        public sealed class OpusEncoder : IDisposable
        {
            ...
            public int Bitrate
            {
                get
                {
                    ...
                    int bitrate;
                    var ret = OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.GetBitrateRequest, out bitrate);
                    if (ret < 0)
                ...
                set
                {
                    ...
                    var ret = OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.SetBitrateRequest, value);
                    if (ret < 0)
            ...
            public bool EnableForwardErrorCorrection
            {
                get
                {
                    ...
                    int fec;
                    var ret = OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.GetInbandFECRequest, out fec);
                    if (ret < 0)
                ...
                set
                {
                    ...
                    var ret = OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.SetInbandFECRequest, Convert.ToInt32(value));
                    if (ret < 0)
            ...
            public float PacketLoss
            {
                get
                {
                    ...
                    int bitrate;
                    var ret = OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.GetPacketLossPercRequest, out bitrate);
                    if (ret < 0)
                ...
                set
                {
                    ...
                    var ret = OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.SetPacketLossPercRequest, (int)(value * 100));
                    if (ret < 0)
            ...
            public void Reset()
            {
                ...
                int _;
                OpusNativeMethods.opus_encoder_ctl(_encoder, Ctl.ResetState, out _);
            }
            ...
            public void Dispose()
            {
                ...
                if (_encoder != IntPtr.Zero)
                {
                    OpusNativeMethods.opus_encoder_destroy(_encoder);
        ...
        public sealed class OpusDecoder : IDisposable
        {
            ...
            public OpusDecoder(int outputSampleRate, int outputChannelCount)
            {
                ...
                int error;
                _decoder = OpusNativeMethods.opus_decoder_create(outputSampleRate, outputChannelCount, out error);
                if ((OpusErrors)error != OpusErrors.Ok)
