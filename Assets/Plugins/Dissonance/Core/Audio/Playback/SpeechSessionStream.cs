...
namespace Dissonance.Audio.Playback
{
        ...
        : IJitterEstimator
    {
        ...
        private readonly WindowDeviationCalculator _arrivalJitterMeter = new WindowDeviationCalculator(32);
        ...
        {
            if (_awaitingActivation.Count > 0 && _awaitingActivation.Peek().ActivationTime < (now ?? DateTime.Now))
            {
